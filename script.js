...
// Rimosse chiamate a funzioni ridondanti (initAnimations, initScrollToTop)
// ========================================
document.addEventListener('DOMContentLoaded', () => {
  ...
  initFAQAccordion();
  initFormValidation();
  // initScrollToTop(); <-- RIMOSSO (RIDONDANTE)
  // initAnimations(); <-- RIMOSSO (RIDONDANTE)
});
...
// Correzione bug ingrandimento pre-chiusura sincronizzando il JS con il CSS.
// ========================================
function initModals() {
  ...
  function closeModal(modal) {
    modal.classList.remove('show');
    // Aspetta la fine dell'animazione (200ms in CSS) prima di nascondere
    setTimeout(() => {
      modal.style.display = 'none';
    }, 200); // MODIFICATO: Sincronizzato con il CSS e velocizzato
    body.style.overflow = '';
...
function initAccessibility() {
  // Aggiunge un'area ARIA live per gli screen reader
...
function initHeaderScroll() {
  ...
  handleScroll(); // Esegui subito all'avvio
}
...
function initFormValidation() {
  ...
  // Reset bordo al focus/digitazione
...
// ========================================
// PERFORMANCE LOGGING (RIMOSSO - RIDONDANTE)
// ========================================
