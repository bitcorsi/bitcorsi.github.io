...
- Gestione menu mobile
  */
  ...
  // ✅ NUOVO: Chiudi menu cliccando sullo spazio bianco fuori dai link
...
- Carica e mostra titolo, sottotitolo, promo natalizia (se attiva) e corsi da corsi.json
  */
  ...
  const promoContainer = document.querySelector(’#promo-natale-container’);
  ...
  sectionHeader.innerHTML = `<h2>${data.titoloCorsi}</h2> <p class="section-subtitle">${data.sottotitoloCorsi || ''}</p>`;
  }
